...
void SumMatrixColInArray(int arr[3][3], int arrSum[3], short row, short col)
{
    for (short i = 0; i < row; i++)
    {
        arrSum[i] = SumOfCol(arr, row, i);
    }
}

void PrintArrayOfSumCols(int arr[3], short Row)
{
...
int main()
{
    ...
    SumMatrixColInArray(Matrix, arr, 3, 3);
    PrintArrayOfSumCols(arr, 3);
